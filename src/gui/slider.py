...
class LabeledSlider(QtWidgets.QWidget):
    def __init__(self, minimum, maximum, interval=1, orientation=Qt.Horizontal,
            labels=None, parent=None, side='left'):
        ...
        if orientation==Qt.Horizontal and (side=='above' or side=='below'):
            self.layout=QtWidgets.QVBoxLayout(self)
        elif orientation==Qt.Vertical and (side=='left' or side=='right'):
        ...
        if orientation==Qt.Horizontal:
            if side == 'above':
                self.sl.setTickPosition(QtWidgets.QSlider.TicksAbove)
            elif side == 'below':
            ...
            if side == 'left':
                ...
                self.sl.setTickPosition(QtWidgets.QSlider.TicksRight)
